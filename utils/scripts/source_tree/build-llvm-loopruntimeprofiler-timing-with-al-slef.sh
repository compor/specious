...
PIPELINE_CONFIG_FILE="${SRC_DIR}/configs/pipelines/loopruntimeprofiler_timing_with_al_slef.txt"

[[ -z "${ANNOTATELOOPS_DIR}" ]] && echo "error: ANNOTATELOOPS_DIR is not set" && exit 1
[[ -z "${LOOPRUNTIMEPROFILER_DIR}" ]] && echo "error: LOOPRUNTIMEPROFILER_DIR is not set" && exit 1
